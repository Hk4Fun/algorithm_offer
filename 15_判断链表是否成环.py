...
'''
'''主要思路：
（链表要么单向，要么整体成环，不会局部有环，局部有环说明结点要有两个分支）
...
Test('Test1', linkNodes([1, 2, 3, 4, 5, 6, 7, 8], False), False)  # 单向链表，多个结点
Test('Test2', linkNodes([1], False), False)  # 单向链表，单个结点
Test('Test3', linkNodes([1, 2, 3, 4, 5, 6, 7, 8], True), True)  # 循环链表，多个结点
Test('Test4', linkNodes([1], True), True)  # 循环链表，单个结点
Test('Test5', linkNodes([], False), None)  # 空链表
